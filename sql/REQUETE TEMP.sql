...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Marteau', 'Marteau en acier avec un manche en bois pour travaux de réparation', 15.00, 'im_4a6_Marteau_image.jpg', 100, '11111111-1111-1111-1111-111111111111'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Tournevis', 'Tournevis avec embouts interchangeables pour vissage et dévissage', 10.00, 'im_4a6_Tournevis_image.jpg', 80, '11111111-1111-1111-1111-111111111111'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Scie à main', 'Scie à main avec une lame en acier pour couper du bois', 25.00, 'im_4a6_Scie_main_image.jpg', 60, '22222222-2222-2222-2222-222222222222'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Perceuse électrique', 'Perceuse sans fil avec plusieurs vitesses et perceuses', 150.00, 'im_4a6_Perceuse_image.jpg', 40, '22222222-2222-2222-2222-222222222222'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Pince coupante', 'Pince coupante en acier inoxydable pour couper des fils', 12.00, 'im_4a6_Pince_coupante_image.jpg', 50, '11111111-1111-1111-1111-111111111111'),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Pince multiprise', 'Pince multiprise en acier pour saisir des objets de différentes tailles', 18.00, 'im_4a6_Pince_multiprise_image.jpg', 70, '11111111-1111-1111-1111-111111111111');
